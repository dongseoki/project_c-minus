...
%token VOID INT IF ELSE WHILE RETURN INPUT OUTPUT
%token PLUS MINUS MULTIPLY DIVIDE LT LE GT GE EQ NE
%token ASSIGN COMMA SEMICOLON LPAR RPAR LBRACE RBRACE LBRACKET RBRACKET
